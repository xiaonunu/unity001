...
public class tk2dSpriteCollectionBuilder
{
	...
	static Texture2D ProcessTexture(tk2dSpriteCollection settings, bool additive, bool stretchPad, Texture2D srcTex, int sx, int sy, int tw, int th, ref SCGE.SpriteLut spriteLut, int padAmount)
	{
		...
		if (numNotTransparent > 0)
		{
			...
			case tk2dSpriteCollection.TextureCompression.Dithered16Bit_4444:
				tk2dTextureProcessing.tk2dFloydSteinbergDithering.DitherTexture(dtex, TextureFormat.ARGB4444, 0, 0, dtex.width, dtex.height); break;
			case tk2dSpriteCollection.TextureCompression.Dithered16Bit_565:
				tk2dTextureProcessing.tk2dFloydSteinbergDithering.DitherTexture(dtex, TextureFormat.RGB565, 0, 0, dtex.width, dtex.height); break;
			}
			dtex.Apply();
    ...
    public static bool Rebuild(tk2dSpriteCollection gen)
    {
		...
		// Build atlas
		tk2dAtlas.AtlasBuilder atlasBuilder = new tk2dAtlas.AtlasBuilder(gen.maxTextureSize, gen.maxTextureSize, gen.allowMultipleAtlases?64:1, gen.forceSquareAtlas);
