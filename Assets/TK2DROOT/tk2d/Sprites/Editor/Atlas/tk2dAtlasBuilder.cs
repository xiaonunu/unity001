...
namespace tk2dAtlas
{
	...
	public class AtlasData
	{
		...
		public AtlasEntry FindEntryWithIndex(int index)
		{
	...
	public class AtlasBuilder
	{
		...
		List<AtlasData> atlases = new List<AtlasData>();
		List<int> remainingRectIndices = new List<int>();
		
		bool oversizeTextures = false;

		public AtlasBuilder(int atlasWidth, int atlasHeight, int maxAllowedAtlasCount, bool forceSquare)
		{
